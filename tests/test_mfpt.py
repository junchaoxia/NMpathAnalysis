...
from nmpath.first_passage_time import MatrixFPT, MarkovFPT
...
class TestMFPT(unittest.TestCase):
    ...
    def testMatrixFPT2TargetMicrostate(self):
        ...
        self.assertTrue(
            np.allclose(mpfts_to_micro,
                     np.array([6.42091818, 5.35994556, 7.24671735, 6.81752892, 0.0])
                     )
        )
    ...
    def testMatrixFPTMatrix(self):
        ...
        result = np.array(
            [[0.,         2.62899481, 7.65074814, 4.37254081, 6.42091818],
             [5.58481382, 0.,         6.21851058, 4.00702426, 5.35994556],
             [4.98545579, 3.15239528, 0.,         3.43921253, 7.24671735],
             [4.37802054, 3.33697554, 6.03713191, 0.,         6.81752892],
             [4.92017417, 3.26320798, 7.20000135, 4.36442835, 0.        ]]
        )
