...
'''
import numpy as np
from nmpath.auxfunctions import pops_from_tmatrix, check_tmatrix, random_markov_matrix
from nmpath.mfpt import mfpts_matrix, min_commute_time, max_commute_time
import copy
import operator
