...
class DirectFPT:
    ...
    @classmethod
    def mean_fpts(self, trajectories, stateA=None, stateB=None, discrete=True,
        ...
        passage_timesAB, passage_timesBA, tb_values = self.fpts(trajectories,
                                                                  stateA,
                                                                  stateB, discrete,
                                                                  n_variables,
                                                                  lag_time)
    ...
    @classmethod
    def fpts(self, trajectories, stateA=None, stateB=None, discrete=True,
             n_variables=None, lag_time=1):
...
class MatrixFPT:
    ...
    @classmethod
    def mean_fpts(self, tmatrix, stateA, stateB, lag_time=1):
        pass

    @classmethod
    def directional_mfpt(self, transition_matrix, stateA, stateB,
    ...
    @classmethod
    def mfpts_to_target_microstate(self, transition_matrix, target, lag_time=1):
    ...
    @classmethod
    def mfpts_matrix(self, transition_matrix, lag_time=1):
        ...
        for i in range(size):
            temp_values.append(self.mfpts_to_target_microstate(transition_matrix,
                                                          i, lag_time))
    ...
    @classmethod
    def min_commute_time(self, matrix_of_mfpts):
    ...
    @classmethod
    def max_commute_time(self, matrix_of_mfpts):
    ...
    @classmethod
    def fpt_distribution(self, t_matrix, initial_state, final_state,
        ...
        for istateIndex in range(len(ini_state)):
            ...
            self._calc_fmatrix(Fmatrix, tmatrix, prevFmatrix, list_of_pdfs,
    ...
    def _calc_fmatrix(self, Fmatrix, tmatrix, prevFmatrix, list_of_pdfs,
                      max_n_lags, ini_state, istateIndex, f_state):
...
class MarkovFPT(MatrixFPT):
    ...
    @classmethod
    def mean_fpts(self, markov_tmatrix, stateA, stateB, lag_time=1):
    ...
    @classmethod
    def markov_commute_time(self, transition_matrix, stateA, stateB, lag_time=1):
        mfpts = self.mean_fpts(transition_matrix, stateA, stateB, lag_time)
...
class NonMarkovFPT(MatrixFPT):
    ...
    @classmethod
    def mean_fpts(self, nm_transition_matrix, stateA, stateB, lag_time=1):
